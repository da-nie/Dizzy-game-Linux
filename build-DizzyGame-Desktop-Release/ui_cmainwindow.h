...
public:
    ...
    void setupUi(QMainWindow *CMainWindow)
    {
        ...
        CLabelArea = new QLabel(centralWidget);
        CLabelArea->setObjectName(QString::fromUtf8("CLabelArea"));

        gridLayout->addWidget(CLabelArea, 0, 0, 1, 1);
